...
# PowerZone 410 time registers (per genmon)
REG_TIME_HR_MIN = 0x015D
REG_TIME_SEC_DOW = 0x015E  # Sunday=0..Saturday=6 (low byte)
REG_TIME_MONTH_DAY = 0x015F
REG_TIME_YEAR = 0x0160
...
def map_dow(dt):
    ...
    # PowerZone expects Sunday=0..Saturday=6
...
def main():
    ...
    # PowerZone (per genmon) writes registers individually
    ...
    instrument.write_register(REG_TIME_YEAR, now.year)
    ...
    print(f"Read back: 015D={r_hrmin}, 015E={r_secdow}, 015F={r_monthday}, 0160={r_year}")
    print("Done.")
